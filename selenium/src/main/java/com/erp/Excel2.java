...
FileInputStream fi = new FileInputStream("C:\\Users\\swamy\\Desktop\\Swamy iostreams HMS\\Swamy INPUT\\LoginTD1.xls");
	  Workbook w = Workbook.getWorkbook(fi);
	  Sheet s = w.getSheet("MTC");


//Create the result file under the result folder	  
FileOutputStream fo = new FileOutputStream("C:\\Users\\swamy\\Desktop\\Swamy iostreams HMS\\swamyoutputdisplay\\seleniumResult.xls");
...
jxl.write.Label rs = new jxl.write.Label(2, 0, "Results");
  ...
  public void beforeTest() throws Exception {
	 //System.setProperty("webdriver.chrome.driver", "D:\\Swamy Kumar\\CompanyAUTOMATION SELEniumland forMTCPRODUCTS\\lib\\chromedriver.exe");
